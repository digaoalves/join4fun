...
function checkUnchckPreference(objectSelected) {
    ...
    if (objectSelected.id == "flxBasketball") {
        if (!frmPreferences.flxBasketBallCheck.isVisible) frmPreferences.flxBasketBallCheck.isVisible = true;
        else frmPreferences.flxBasketBallCheck.isVisible = false;
        preference = "Basketball";
    } else if (objectSelected.id == "flxSoccer") {
        if (!frmPreferences.flxSoccerCheck.isVisible) frmPreferences.flxSoccerCheck.isVisible = true;
        else frmPreferences.flxSoccerCheck.isVisible = false;
        preference = "Soccer";
    } else if (objectSelected.id == "flxCricket") {
        if (!frmPreferences.flxCricketCheck.isVisible) frmPreferences.flxCricketCheck.isVisible = true;
        else frmPreferences.flxCricketCheck.isVisible = false;
        preference = "Cricket";
    } else if (objectSelected.id == "flxTennis") {
        if (!frmPreferences.flxTennisCheck.isVisible) frmPreferences.flxTennisCheck.isVisible = true;
        else frmPreferences.flxTennisCheck.isVisible = false;
        preference = "Tennis";
    } else if (objectSelected.id == "flxFootball") {
        if (!frmPreferences.flxFootballCheck.isVisible) frmPreferences.flxFootballCheck.isVisible = true;
        else frmPreferences.flxFootballCheck.isVisible = false;
        preference = "Football";
    } else if (objectSelected.id == "flxRun") {
        if (!frmPreferences.flxRunCheck.isVisible) frmPreferences.flxRunCheck.isVisible = true;
        else frmPreferences.flxRunCheck.isVisible = false;
        preference = "Run";
    }
